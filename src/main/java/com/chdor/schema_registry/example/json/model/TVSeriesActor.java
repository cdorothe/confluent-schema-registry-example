...
public class TVSeriesActor {
    ...
    public String toString() {
        ...
        sb.append(TVSeriesActor.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("lastName");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return ((((this.lastName == rhs.lastName)||((this.lastName!= null)&&this.lastName.equals(rhs.lastName)))&&((this.firstName == rhs.firstName)||((this.firstName!= null)&&this.firstName.equals(rhs.firstName))))&&((this.tvShow == rhs.tvShow)||((this.tvShow!= null)&&this.tvShow.equals(rhs.tvShow))));
    }
