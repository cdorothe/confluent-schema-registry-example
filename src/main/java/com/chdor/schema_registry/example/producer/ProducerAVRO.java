...
public class ProducerAVRO {
	...
	public void produce() {
       ...
       // Disable the auto schema registration. If true, the message is always sent because his associoted schema is registred automatically
       ...
       // Serializer class for message <key> that implements the <org.apache.kafka.common.serialization.Serializer> interface.
       // As my message <key> is a String I'm using the StringSerializer.
       // Several serializers are provided by default by Kafka. They are located on the package <org.apache.kafka.common.serialization>
       // To list some of ones:
       // ByteArraySerializer, BytesSerializer, DoubleSerializer, FloatSerializer, IntegerSerializer, LongSerializer and ShortSerializer 
       // You can create your own serializer by implementing the <org.apache.kafka.common.serialization.Serializer> interface.
       props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, KafkaAvroSerializer.class.getName());

       // Serializer class for message <value> that implements the <org.apache.kafka.common.serialization.Serializer> interface.
       ...
       props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, KafkaAvroSerializer.class.getName());
        ...
        tvSeriesActor = TVSeriesActor.newBuilder()
        		.setFirstName("Jaimie")
        		.setLastName("Sommers")
