...
public class ConsumerAvro {
	...
	public void consume() {
		...
		// This value is mandatory and can take any value you want. If not set Kafka
		...
		// Deserializer class for message <key> that implements the
		...
		// Several deserializers are provided by default by Kafka. They are located on
		// the package <org.apache.kafka.common.serialization>
		// To list some of ones:
		// ByteArrayDeserializer, BytesDeserializer, DoubleDeserializer,
		// FloatDeserializer, IntegerDeserializer, LongDeserializer and
		// ShortDeserializer
		// You can create your own Deserializer by implementing the
		...
		// If true, tries to look up the SpecificRecord class (deserialize
		// TVSeriesActor)
		props.put(KafkaAvroDeserializerConfig.SPECIFIC_AVRO_READER_CONFIG, true);

		// Create Kafka consumer
		KafkaConsumer<TVSeriesActorID, TVSeriesActor> consumer = new KafkaConsumer<TVSeriesActorID, TVSeriesActor>(
				props);
