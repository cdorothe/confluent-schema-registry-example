...
public class ConsumerJSON {
	...
	public void consume() {
        ...
        props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, "io.confluent.kafka.serializers.json.KafkaJsonSchemaDeserializer");
        ...
        KafkaConsumer<TVSeriesActorID,TVSeriesActor> kafkaConsumer = new KafkaConsumer<TVSeriesActorID,TVSeriesActor>(props);
