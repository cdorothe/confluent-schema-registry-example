...
public class SchemaRegistry2 {

	private static final Logger logger = org.slf4j.LoggerFactory.getLogger(SchemaRegistry2.class);
...
//		RestService restService = new RestService(new ArrayList<String>(Arrays.asList(baseURL)));
	...
	public static void init(RestService restService1) throws IOException,RestClientException{
...
//			List<String> compatibilities = restService.testCompatibility(registerSchemaRequest, subject, String.valueOf(lastVersion), true);
	...
	public static void purgeAll(RestService restService) throws IOException,RestClientException {
		//String subject = null; 
		Map<String,String> requestProperties = new HashMap<String, String>();
		List<Integer> ids = null;
